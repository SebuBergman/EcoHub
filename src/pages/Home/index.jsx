          ...
          <div className="frontPage_coverImageBox">
            <div className="frontPage_coverImageBox_textContainer">
              <div>
                ...
                <p>
                  At EcoHub, we believe in the power of collective action to
                  bring about positive change on our planet. Our mission is to
                  empower people of all ages to adopt sustainable lifestyles and
                  promote a healthier and greener future.
                </p>
              </div>
            ...
            <div className="frontPage_container1_boxes">
              <div>
                ...
                <p>
                  ...
                  easy-to-use calculators and assessment tools. Gain insights
                  into your daily habits, identify areas for improvement, and
                  make positive changes that benefit both you and the planet.
                </p>
              </div>
              <div className="divider"></div>
              <div>
          ...
          <div className="frontPage_container2_textContainer">
            <div>
              ...
              <p>
                ...
                endless possibilities for positive change. Together, we can
                create a world where people and the planet thrive in harmony.
              </p>
              <p>
                  ...
                  <div className="carousel_flex">
                    ...
                    <div className="carousel_textContainer">
                      ...
                      <p>
                        ...
                        from climate change to biodiversity. Explore a
                        collection of educational videos, success stories and
                        sustainable living tips. Take part in interactive
                        quizzes and challenges and join a lively discussion
                        forum to exchange ideas with a like-minded community.
                      </p>
                    </div>
                  </div>
                </div>
